...
type IProps = NativeStackScreenProps<StoreStackParamsList, 'DiscoverReaders'>

const DiscoverReadersContainer = (props: IProps) => {
...
export default DiscoverReadersContainer
