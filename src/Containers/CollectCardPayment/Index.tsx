...
type IProps = NativeStackScreenProps<StoreStackParamsList, 'CollectCardPayment'>

const CollectCardPaymentContainer = (props: IProps) => {
...
export default CollectCardPaymentContainer
